<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !areas.isValid }">
            ...
            <p v-if="!areas.isValid">One expertise must be selected.</p>
        </div>
        <p v-if="!formIsValid">Plase fix the above erros.</p>
